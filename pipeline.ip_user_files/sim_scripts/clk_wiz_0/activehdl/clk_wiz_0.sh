...
#
# Script generated by Vivado on Thu May 21 22:19:36 +0530 2026
...
# script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Vivado/CompArch/pipelinedGit/pipeline/pipeline.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
