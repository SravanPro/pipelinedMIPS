...
REM
REM Generated by Vivado on Mon Mar 30 10:28:37 +0530 2026
...
echo "xvlog --incr --relax -prj pipelineTB_vlog.prj"
call xvlog  --incr --relax -prj pipelineTB_vlog.prj -log xvlog.log
