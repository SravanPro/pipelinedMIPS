...
REM
REM Generated by Vivado on Sun May 24 23:17:02 +0530 2026
...
echo "xvlog --incr --relax -prj painterTB_vlog.prj"
call xvlog  --incr --relax -prj painterTB_vlog.prj -log xvlog.log
