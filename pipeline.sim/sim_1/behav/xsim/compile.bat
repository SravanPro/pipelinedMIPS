...
REM
REM Generated by Vivado on Fri May 15 22:03:59 +0530 2026
...
echo "xvlog --incr --relax -prj pipelineTB_copyingArray_vlog.prj"
call xvlog  --incr --relax -prj pipelineTB_copyingArray_vlog.prj -log xvlog.log
