...
HD_PWD='C:/Vivado/CompArch/pipelinedGit/pipeline/pipeline.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log parent.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source parent.tcl -notrace
