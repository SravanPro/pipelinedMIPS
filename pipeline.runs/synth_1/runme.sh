...
HD_PWD='C:/Vivado/CompArch/pipelinedGit/pipeline/pipeline.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parent.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parent.tcl
